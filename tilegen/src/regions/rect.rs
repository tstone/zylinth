...
impl TileRect {
    ...
    pub fn inner_slice(&self, horz_padding: usize, vert_padding: usize) -> Option<TileRect> {
...
mod tests {
    ...
    #[test]
    fn width() {
        let region = TileRect::new(0, 0, 5, 10);
    ...
    #[test]
    fn intersect() {
        let a = TileRect::new(0, 0, 5, 10);
        let b = TileRect::new(2, 2, 4, 12);
    ...
    fn intersect_invalid() {
        let a = TileRect::new(0, 0, 5, 10);
        let b = TileRect::new(20, 20, 24, 32);
